...
class GoRoutineStackDescriber : public Allocations::PatternDescriber<Offset> {
 public:
  typedef
  ...
  GoRoutineStackDescriber(const ProcessImage<Offset>& processImage)
      : Allocations::PatternDescriber<Offset>(processImage, "GoRoutineStack") {}
  ...
  virtual void Describe(Commands::Context& context, AllocationIndex /* index */,
    ...
    output << "This allocation matches pattern GoRoutineStack.\n";
    if (explain) {

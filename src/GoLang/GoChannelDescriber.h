...
class GoChannelDescriber : public Allocations::PatternDescriber<Offset> {
 public:
  typedef
  ...
  GoChannelDescriber(const ProcessImage<Offset>& processImage)
      : Allocations::PatternDescriber<Offset>(processImage, "GoChannel") {}
  ...
  virtual void Describe(Commands::Context& context, AllocationIndex /* index */,
    ...
    output << "This allocation matches pattern GoChannel.\n";
    if (explain) {
